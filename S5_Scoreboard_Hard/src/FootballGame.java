...
/**
 * The FootballGame class extends the Game class, and contains Football-specific scoring methods and information about the game, such as the period length and name.
 */
public class FootballGame extends Game{

    /**
     * FootballGame class constructor
    ...
    public FootballGame (Team homeTeam, Team awayTeam) {
        ...
        scoringMethods = Arrays.asList(
                ...
                new ScoringMethod("Extra", 1) // this is for a field goal or safety after a touchdown
        );
    }
    ...
    /**
     * Gets the winning team. Football games cannot result in tie.
